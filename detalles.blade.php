      ...
      <div class="page-content">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ $empleados->nombre }}</li>
          </ol>
        </nav>
              ...
              <div class="content-box-large">
                ...
                <div class="panel-body">
                  ...
                  @endif 
                    ...
                    <p class="h5">Nombre:</p>
                    <p class="h6 mb-3">{{ $empleados->nombre }}</p>

                    <p class="h5">Contraseña:</p>
                    <p class="h6 mb-3">{{ $empleados->contraseña }}</p>
                    

                    <p class="h5">Imagen:</p>
                    <img src="../../../uploads/{{ $empleados->img }}" class="img-fluid" width="20%">                    

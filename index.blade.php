    ...
    <header>
      ...
      <div class="page-content">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin/empleados') }}">Home</a></li>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
              ...
              <div class="content-box-large">
                ...
                <div class="panel-title"><h2>Empleados</h2></div>             
                ...
                <div class="panel-body">
                  ...
                  <a href="{{ route('admin/empleados/crear') }}" class="btn btn-success mt-4 ml-3">  Crear
                  </a>
                                    ...
                                    <div class="table-responsive">
                                      ...
                                      <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            <td class="v-align-middle">{{$emp->nombre}}</td>
                                            <td class="v-align-middle">{{$emp->contraseña}}</td>
                                            
                                            <td class="v-align-middle">
                                              <img src="{!! asset("uploads/$emp->img") !!}" width="30" class="img-responsive">
                                            </td>
                                            <td class="v-align-middle">

                                              <form action="{{ route('admin/empleados/eliminar',$emp->id) }}" method="POST" class="form-horizontal" role="form" onsubmit="return confirmarEliminar()">

                                                <input type="hidden" name="_method" value="PUT">
                                                <input type="hidden" name="_token" value="{{ csrf_token() }}">    
                                                <a href="{{ route('admin/empleados/detalles',$emp->id) }}" class="btn btn-dark">Detalles</a>                                         
                                                <a href="{{ route('admin/empleados/actualizar',$emp->id) }}" class="btn btn-primary">Editar</a>          
